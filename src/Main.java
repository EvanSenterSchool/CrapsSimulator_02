...
public class Main {
    public static void main(String[] args) {
        ...
        boolean do_You_Wanna_PlayAgain;
        ...
        do {
            ...
            if (sum_Of_Dice == 2 || sum_Of_Dice == 3 || sum_Of_Dice == 12) {
                ...
                System.out.println();
                System.out.println();
                System.out.println("You must roll a " + sum_Of_Dice + " In order to win.");
                System.out.println();
                System.out.println("A roll of 7 will result in a loss.");
                do {
                    ...
                    if (reRoll == sum_Of_Dice) {
                        System.out.println();
                        System.out.println("You rolled the sum of your die You win");
                        secondPart = true;
                        playAgain = true;
                    } else if (diceThree == 7) {
                        System.out.println();
            ...
            do {
                ...
                if (playerInput.equalsIgnoreCase("Y")) {
                    ...
                    do_You_Wanna_PlayAgain = true;
                    System.out.println("Sorry to see you leave come back next time");
                } else {
